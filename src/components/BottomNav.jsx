...
export default function BottomNav() {
  const { currentView, switchView, contactAdmin } = useApp();
  ...
  function isActive(view) {
    if (['schemesView', 'categoryListView', 'formView', 'successView'].includes(view)) {
  ...
  return (
    <div className="bottom-nav safe-area">
      <button
        ...
        className={isActive(currentView) ? 'active' : ''}
      >
